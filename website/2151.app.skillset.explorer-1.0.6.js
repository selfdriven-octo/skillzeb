                    ...
                    '<div class="row pt-2">',
                        ...
                        '<div class="col-10">', 
                            ...
                            '<div class="collapse text-secondary small" id="info">',
                                ...
                                '</div>',
                                '<div class="pt-1 pb-2">',
                                    '<a href="https://slfdrvn.ai/research" target="_blank" class="text-muted small">',
                                        'slfdrvn.ai/research',
                                    '</a>',
                                '</div>',
                            '</div>',
                ...
                else
                {
                    ...
                    [
                        '<div class="row pt-5 pb-3 border-bottom border-gray-300">',
                            ...
                            '<div class="col-12 col-md-8 mb-2"><div class="text-muted small">SZI (DID)</div><div>', skill.sdi, '</div></div>'
